...
module.exports.run = async (client, message, args) =>{
     if(!message.member.hasPermission("MANAGE_ROLES")) return message.reply("Ops Me parece que você não tem permissão <:neg:746785984443842603>");
        let embederro = new Discord.MessageEmbed()
            ...
            .addField(`📝 Exemplo`, `a.mute <@user> 1h <motivo>`)
...
if(muterole === null) return message.reply("<:setaazul:746785672022720523> antes de usar esse comando você precisa configurar um cargo para dar pra pessoa, **Para isso use o comando: a.muterole <@cargomute>**")
...
let tempo = args[1]
        ...
        message.reply(`** ${mute.displayName}** foi mutado(a) por: ${ms(ms(tempo))},\n<:setaazul:746785672022720523> Motivo: "**${motivo}**"`);
setTimeout(function(){
